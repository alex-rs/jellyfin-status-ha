...
(function () {
  ...
  var css = [
    ...
    "}",
    ".jsc-card{background:var(--jsc-bg);border-radius:var(--jsc-radius);overflow:hidden!important}",
    ".jsc-cover-wrapper{position:relative;width:100%;padding-bottom:56.25%;overflow:hidden;background:var(--jsc-placeholder-bg);border-radius:var(--jsc-radius,12px)}",
    ".jsc-cover-image{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;display:block}",
